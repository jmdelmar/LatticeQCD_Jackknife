...
void readTwopMesonsFile_0mom(vector<double> *data, char *file, char *dataset, readInfo info);


void readTwop_g5Mesons_Qsq0( vector< vector< vector<double> > > *data, char *homeDir, vector<string> *confs, vector< vector<string> > *srcPos, char *fnTemplate, readInfo info );
...
// only once, represented in the given filename template by a '*CONF*'.
...
// represented in the given filename template by a '*CONF*' and its source
// postition represented by *SRC*.
